...
A Pro subscription could unlock team selection and priority matching. Enterprise private networks are a future option. An illustrative JPY 1,500 monthly price with 1,000 subscribers yields JPY 1.5 million monthly revenue before expenses. Neither pricing nor subscriber count is validated. This is not profit, traction, or a TAM estimate.

Teams pay their own AI costs. Platform costs include infrastructure, support, dispute handling, acquisition, payment processing and on-chain recording. Next validation: repeat exchanges, quality, fulfillment time, and willingness to pay.
